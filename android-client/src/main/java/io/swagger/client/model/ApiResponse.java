...
public class ApiResponse {
  ...
  public boolean equals(Object o) {
    ...
    return (this.code == null ? apiResponse.code == null : this.code.equals(apiResponse.code)) &&
        (this.summary == null ? apiResponse.summary == null : this.summary.equals(apiResponse.summary)) &&
        (this.response == null ? apiResponse.response == null : this.response.equals(apiResponse.response));
  }

...
public class Session {
  ...
  public boolean equals(Object o) {
    ...
    return (this.id == null ? session.id == null : this.id.equals(session.id)) &&
        (this.ownerId == null ? session.ownerId == null : this.ownerId.equals(session.ownerId)) &&
        (this.vehicleId == null ? session.vehicleId == null : this.vehicleId.equals(session.vehicleId)) &&
        (this.status == null ? session.status == null : this.status.equals(session.status)) &&
        (this.startTime == null ? session.startTime == null : this.startTime.equals(session.startTime)) &&
        (this.lastMessage == null ? session.lastMessage == null : this.lastMessage.equals(session.lastMessage));
  }
